...
public class CourseAdapter extends RecyclerView.Adapter<CourseAdapter.ViewHolder> {
    ...
    public CourseAdapter(Activity context, List<Result> list) {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(@NonNull View itemView) {
            super(itemView);
            ivImage = itemView.findViewById(R.id.iv_course_detail_image);
            tvName = itemView.findViewById(R.id.tv_course_detail_name);
            tvTotalAmount = itemView.findViewById(R.id.tv_course_detail_total_amount_2);
            tvAmount = itemView.findViewById(R.id.tv_course_detail_amount_2);
